    ...
    (function(global, factory) {
        ...
        Bezier.prototype.length = function() {
            ...
            for (var i = 0; i <= steps; i += 1) {
                var t = i / steps;
                var cx = this._point(t, this.startPoint.x, this.control1.x, this.control2.x, this
                    .endPoint.x);
                var cy = this._point(t, this.startPoint.y, this.control1.y, this.control2.y, this
                    .endPoint.y);
                if (i > 0) {
                    var xdiff = cx - px;
                    var ydiff = cy - py;
        ...
        SignaturePad.prototype._calculateCurveWidths = function(curve) {
            ...
            var velocity = this.velocityFilterWeight * endPoint.velocityFrom(startPoint) + (1 - this
                .velocityFilterWeight) * this._lastVelocity;
        ...
        SignaturePad.prototype._toSVG = function() {
            ...
            this._fromData(pointGroups, function(curve, widths) {
                ...
                if (!isNaN(curve.control1.x) && !isNaN(curve.control1.y) && !isNaN(curve
                        .control2.x) && !isNaN(curve.control2.y)) {
                    var attr = 'M ' + curve.startPoint.x.toFixed(3) + ',' + curve.startPoint.y
                        .toFixed(3) + ' ' + ('C ' + curve.control1.x.toFixed(3) + ',' + curve
                            .control1.y.toFixed(3) + ' ') + (curve.control2.x.toFixed(3) + ',' +
                            curve.control2.y.toFixed(3) + ' ') + (curve.endPoint.x.toFixed(3) +
                ...
                var dotSize = typeof _this2.dotSize === 'function' ? _this2.dotSize() : _this2
                    .dotSize;
    ...
    var wrapper = document.getElementById("signature-pad"),
        ...
        patient_signature = document.getElementById('patient_signature'),
    ...
    savePNGButton.addEventListener("click", function(event) {
        if (signaturePad.isEmpty()) {
            ...
            const canvasDataUri = signaturePad.toDataURL("image/png")
            patient_signature.value = canvasDataUri
