...
@section('toolbar-right')
    <span class="text-muted font-weight-bold mr-4">{{ __('lang.display') }}</span>
@endsection
        ...
        <div class="col-lg-4">
            <div class="card card-custom gutter-b">
                <div class="card-header px-2">
                    <h3 class="card-title">{{ __('lang.add_display') }}</h3>
                </div>
                <form class="form" action="{{ route('master.display.store') }}" method="POST"
                                            ...
                                            <div class="dropdown dropdown-inline">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="navi navi-hover">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="{{ route('master.displayshow.counterView', $data->id) }}" class="navi-link btn w-100">
                                                                <span class="navi-icon">
                                                                    <i class=" fa fa-eye"></i> {{ __('lang.view') }}
                                                                </span>
                                                            </a>
