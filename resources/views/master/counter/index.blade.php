...
@section('toolbar-right')
    <span class="text-muted font-weight-bold mr-4">{{ __('lang.counter') }}</span>
@endsection
        ...
        <div class="col-lg-4">
            <div class="card card-custom gutter-b">
                <div class="card-header px-2">
                    <h3 class="card-title">{{ __('lang.add_counter') }}</h3>
                </div>
                <form class="form" action="{{ route('master.counter.store') }}" method="POST">
                    @csrf
        ...
        <div class=" col-lg-8">
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <h3 class="card-title">{{ __('lang.counter_list') }}</h3>
                </div>
                <div class="card-body p-2">

                    <form action="{{ route('master.counter.filter') }}" method="post">
                        @csrf
                        @php
                            $name = $_GET['name'] ?? '';
                            $status = $_GET['status'] ?? '';
                                                    ...
                                                    <ul class="navi navi-hover">
                                                        <li class="navi-item">
                                                            @if ($data->status == 'active')
                                                                <a href="{{ route('master.counter.status', $data->id) }}" class="navi-link ">
                                                        ...
                                                        <li class="navi-item">
                                                            <button type="button" title="{{ __('lang.view') }}"
                                                                ...
                                                                onclick="viewModalShow(`{{ route('master.counter.show', $data->id) }}`)">
                                                                <span class="navi-icon">
                                                        ...
                                                        <li class="navi-item">
                                                            <button type="button"
                                                                data-url="{{ route('master.counter.edit', $data->id) }}"
                                                                title="{{ __('lang.edit') }}"
